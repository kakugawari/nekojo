...
(function (root, factory) {
  ...
  const PREF_TABLE = [
    ['北海道', 0, 'まつにゃえ 慶広', [2], '蝦夷地', 'どこまでも広い大地と、おいしい海の幸の国。寒さに強い猫が多いにゃ。'],
    ['青森', 1, 'つがにゃ 為信', [1, 3, 5], '陸奥', 'りんごの香りがただよう北の国。海をこえると北海道にゃ。'],
    ['岩手', 1, 'にゃんぶ 信直', [2, 4, 5], '陸中', '山も森も大きな国。馬と猫がのんびり暮らしているにゃ。'],
    ['宮城', 1, '伊達 にゃさむね', [3, 5, 6, 7], '陸前', 'おしゃれな独眼竜の大名がおさめる国。牛たんが名物にゃ。'],
    ['秋田', 1, 'あんどう にゃすえ', [2, 3, 4, 6], '羽後', 'お米と雪の国。なまはげの面に、猫もびっくりにゃ。'],
    ['山形', 1, 'もがにゃ 義光', [4, 5, 7, 15], '羽前', 'さくらんぼが実る山の国。温泉もたくさんあるにゃ。'],
    ['福島', 1, 'あしにゃ 盛氏', [4, 6, 8, 9, 10, 15], '岩代', '大きな湖と桃の国。東北の入り口を守っているにゃ。'],
    ['茨城', 2, 'さたけ にゃしげ', [7, 9, 11, 12], '常陸', '納豆とメロンの国。ねばり強い猫侍がいるにゃ。'],
    ['栃木', 2, 'うつにゃみや 国綱', [7, 8, 10, 11], '下野', 'いちごと、きらびやかなお宮の国にゃ。'],
    ['群馬', 2, 'にゃがの 業正', [7, 9, 11, 15, 20], '上野', '山と温泉の国。からっ風に負けない猫が守るにゃ。'],
    ['埼玉', 2, 'にゃりた 氏長', [8, 9, 10, 12, 13, 19, 20], '武蔵', '水に浮かぶ城で有名な国。まわりの国とたくさんつながっているにゃ。'],
    ['千葉', 2, 'さとにゃ 義堯', [8, 11, 13], '下総', '海にかこまれた半島の国。落花生がおいしいにゃ。'],
    ['東京', 2, 'おおた にゃんかん', [11, 12, 14, 19], '武蔵', '小さいけれど、にぎやかな城下町の国にゃ。'],
    ['神奈川', 2, 'ほうじょう にゃうじやす', [13, 19, 22], '相模', 'かたい守りの小田原城がある国。なかなか落ちないにゃ。'],
    ['新潟', 3, 'うえすぎ にゃんしん', [6, 7, 10, 16, 20], '越後', 'お米どころの国。戦の神とよばれる大名がいるにゃ。'],
    ['富山', 3, 'さっさ にゃりまさ', [15, 17, 20, 21], '越中', '高い山と、ひかる海の国。ますのすしが名物にゃ。'],
    ['石川', 3, 'まえにゃ 利家', [16, 18, 21], '加賀', '金ぱくがきらきら光る、豊かな百万石の国にゃ。'],
    ['福井', 3, 'あさくにゃ 義景', [17, 21, 25, 26], '越前', '恐竜の骨が見つかる国。かにもおいしいにゃ。'],
    ['山梨', 3, 'たけにゃ 信玄', [11, 13, 14, 20, 22], '甲斐', '風林火山の旗の国。ぶどうと富士山が見えるにゃ。'],
    ['長野', 3, 'むらかみ にゃしきよ', [10, 11, 15, 16, 19, 21, 22, 23], '信濃', '山にかこまれた大きな国。となりの国がいちばん多いにゃ。'],
    ['岐阜', 3, 'さいとう にゃんさん', [16, 17, 18, 20, 23, 24, 25], '美濃', '天下をねらう者が目指す、山の上の城の国にゃ。'],
    ['静岡', 3, 'いまがわ にゃしもと', [14, 19, 20, 23], '駿河', '富士山とお茶の国。海道一の弓取りがいるにゃ。'],
    ['愛知', 3, '織田 にゃぶなが', [20, 21, 22, 24], '尾張', '天下統一を夢見る大名が生まれた国にゃ。'],
    ['三重', 4, 'きたばたけ にゃものり', [21, 23, 25, 26, 29, 30], '伊勢', '海と山にかこまれた豊かな国。お伊勢参りの猫でにぎわうにゃ。'],
    ['滋賀', 4, 'あざい にゃがまさ', [18, 21, 24, 26], '近江', '日本一大きな湖がある国。都への近道にゃ。'],
    ['京都', 4, 'あしかが にゃしあき', [18, 24, 25, 27, 28, 29], '山城', '将軍のいる都の国。ここをとれば天下は近いにゃ。'],
    ['大阪', 4, 'とよとみ にゃでよし', [26, 28, 29, 30], '摂津', '商いでにぎわう、天下の台所の国にゃ。'],
    ['兵庫', 4, 'べっしょ にゃがはる', [26, 27, 31, 33, 36], '播磨', '白くかがやく大きな城の国。海をわたると四国にゃ。'],
    ['奈良', 4, 'まつにゃが 久秀', [24, 26, 27, 30], '大和', '大仏さまと鹿の国。ふしぎな茶釜を持つ大名がいるにゃ。'],
    ['和歌山', 4, 'さいか にゃごいち', [24, 27, 29], '紀伊', 'みかんと鉄砲の国。腕のいい猫がそろっているにゃ。'],
    ['鳥取', 5, 'やまにゃ 豊国', [28, 32, 33, 34], '因幡', '大きな砂丘の国。梨がおいしいにゃ。'],
    ['島根', 5, 'あまにゃ 経久', [31, 34, 35], '出雲', '神さまが集まる国。縁むすびの猫がいるにゃ。'],
    ['岡山', 5, 'うきた にゃおいえ', [28, 31, 34, 37], '備前', '桃太郎とききびだんごの国。橋をわたると四国にゃ。'],
    ['広島', 5, 'もうり にゃとなり', [31, 32, 33, 35, 38], '安芸', '三本の矢の教えの国。島がたくさん浮かんでいるにゃ。'],
    ['山口', 5, 'おおうち にゃしたか', [32, 34, 40], '長門', 'ふぐの国。海をこえると九州にゃ。'],
    ['徳島', 6, 'みよし にゃがよし', [28, 37, 38, 39], '阿波', '渦潮と阿波おどりの国。猫もおどるにゃ。'],
    ['香川', 6, 'そごう にゃずまさ', [33, 36, 38], '讃岐', 'いちばん小さな国。でも、うどんは天下一にゃ。'],
    ['愛媛', 6, 'こうの にゃちなお', [34, 36, 37, 39], '伊予', 'みかんと古い温泉の国。海の道で広島とつながるにゃ。'],
    ['高知', 6, 'ちょうそかべ にゃとちか', [36, 38], '土佐', 'かつおと太平洋の国。四国をまとめたい大名がいるにゃ。'],
    ['福岡', 7, 'たちばな にゃんせつ', [35, 41, 43, 44], '筑前', '九州の入り口の国。いなずまを切った猫侍がいるにゃ。'],
    ['佐賀', 7, 'りゅうぞうじ にゃかのぶ', [40, 42], '肥前', '焼き物の国。くまのように強い大名がいるにゃ。'],
    ['長崎', 7, 'おおむら にゃみただ', [41], '肥前 (長崎)', '南蛮船がやってくる港の国。めずらしい物がいっぱいにゃ。'],
    ['熊本', 7, 'かとう にゃよまさ', [40, 44, 45, 46], '肥後', '火の山と、かたい石垣の城の国にゃ。'],
    ['大分', 7, 'おおとも にゃんりん', [40, 43, 45], '豊後', '湯けむりがあちこちから上がる温泉の国にゃ。'],
    ['宮崎', 7, 'いとう にゃしすけ', [43, 44, 46], '日向', 'お日さまがいっぱいの国。マンゴーが甘いにゃ。'],
  ...
  function conquestReward(state, plan) {
    const r = Math.min(plan.level, rankIndexOf(state));
    const mul = townEffects(state).meritMul;
    const one = Math.round(enemyReward(r, false) * mul), boss = Math.round(enemyReward(r, true) * mul);
    const merit = one * (plan.count - 1) + boss;
    return merit + Math.round(merit * 0.3);
  }
